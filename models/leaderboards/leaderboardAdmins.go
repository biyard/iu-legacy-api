...
func (r LeaderboardAdmin) Collection() string {
	return "leaderboard-admin"
}

func (r LeaderboardAdmin) Table() string {
	return r.Collection()
}

func (r LeaderboardAdmin) Indexes() []mongo.IndexModel {
