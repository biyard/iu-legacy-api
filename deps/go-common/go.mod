...
require (
	biyard.co/iuniverse-webworker v0.0.0-00010101000000-000000000000
...
replace github.com/klaytn/klaytn => ../libs/klaytn

replace biyard.co/iuniverse-webworker => ../iuniverse-webworker
